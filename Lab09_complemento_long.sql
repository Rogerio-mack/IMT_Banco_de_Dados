/*
Q1. Para base de dados abaixo, selecione para a banda 'Metallica' o nome de seus
albúns e ano

Q2. Para base de dados abaixo, selecione para a banda 'Metallica' o nome de seus
albúns e suas músicas
*/
...
CONSTRAINT fk_record_label_in_artist FOREIGN KEY (record_label_id) REFERENCES
record_label (id),
...
INSERT INTO song VALUES(36,13,'Sgt. Pepper''s Lonely Hearts Club Band (Reprise)',
1.3166);
