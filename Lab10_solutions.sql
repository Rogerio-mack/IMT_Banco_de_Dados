/* 4. listar o nome dos proprietários de todos os veículos e suas respectivas placas, ordenados pelo nome do cliente.*/
...
/* 5. listar o nome dos proprietários de todos os veículos e suas respectivas placas, ordenados pelo nome do cliente, incluindo na listagem os clientes que não possuem veículos. */

select C.nomecliente, V.placa  from veiculo as V right outer join cliente  as C
	on V.idCliente = C.idcliente
    order by C.nomecliente;

/* 6. listar o nome dos proprietários de todos os veículos e suas respectivas placas, ordenados pelo nome do cliente, incluindo na listagem os veículos que não têm clientes à eles associados. */
...
/* 7. Escrever a query SQL para exibir o CPF e o nome do cliente que possui o veículo de placa ZYT4WR55.  */

select C.CPF, C.nomecliente  from veiculo as V inner join cliente as C
	on V.idCliente = C.idcliente 
    where V.placa = 'ZU78JU49';
    
/* 8. SQL para exibir o modelo,  a placa e a cor dos veículos estacionados no pátio de código 1. */
...
/* 9. SQL para exibir o modelo,  a placa e a cor dos veículos estacionados no pátio de código 1. */
    
select V.modelo, V.placa, V.cor from veiculo as V inner join estaciona as E
	on E.idveiculo = V.idveiculo
    where E.idpatio = 2;
    
/* 10. query SQL para exibir o modelo,  a placa e a cor dos veículos estacionados no pátio de código 2. */
...
/* 11. query SQL para exibir o modelo, a placa, o ano do veículos estacionados em qualquer um dos pátios da empresa; */
